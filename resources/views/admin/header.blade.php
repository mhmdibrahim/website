<header>
		<div class="navbar navbar-inverse navbar-fixed-left col-lg-3">
		  ...
		  <ul class="nav navbar-nav">
			   ...
			   <li><a href="/about"><i class="fa fa-flag" aria-hidden="true"></i>About</a></li>
			   <li><a href="/services"><i class="fa fa-server" aria-hidden="true"></i>Services</a></li>
			   <li><a href="/teams"><i class="fa fa-steam" aria-hidden="true"></i>Team</a></li>
			   <li><a href="/portfolio"><i class="fa fa-cog" aria-hidden="true"></i>Portfolio</a></li>
			   <li><a href="/clients"><i class="fa fa-child" aria-hidden="true"></i>Clients</a></li>
