				...
				<table class="table ">
                  ...
                  @foreach($about_us as $about)
				    <tr>
                      ...
                      <td><a><button type="button" class="btn btn-info" data-toggle="modal" data-target="#editAbout" data-whatever="@mdo"  class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button></a></td>
